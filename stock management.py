...
#creating database necessary for this program#
def create_database():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")				#change as per system
...
#list operation under product management#
def list_database():
        mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")   					#change as per system
        mycursor=mydb.cursor()
        sql="show tables;"
...
#add operation under purchase management#
def add_order():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")				#change as per system
           mycursor=mydb.cursor()
           now = datetime.datetime.now()
...
#list operation under purchase management#
def list_order():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql", database="stock")					#change as per system
           mycursor=mydb.cursor()
...
#add operation under product management#
def add_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")				#change as per system
           mycursor=mydb.cursor()
...
#update operation under product management#
def update_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
           print("Updating the stock")
           code=int(input("Enter the product code :"))
           qty=int(input("Enter the quantity added:"))
...
#delete operation under product management#
def delete_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
           code=int(input("Enter the product code :"))
...
#search operation under product management#
def search_product():
...
#list operation menu under product management#
def list_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
...
#list operation using code of product under product management#
...
#adding sales under sales management#
def sale_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
...
#lists sales under sales management#
def list_sale():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
...
#list using category in list operation#         
def list_prcat(cat):
           mydb=mysql.connector.connect(host="localhost",user="root",passwd="arnav@mysql",database="stock")
           mycursor=mydb.cursor()
           print (cat)
